...
Using the Bayes factor test, we can use \package{peppwR} to look at fundamental experimental design questions with the DDA dataset.
...
The \package{peppwR} then can be used to get a good picture of how informative a given dataset type might and give researcher realistic assessments that can inform experimental design decisions and result interpretation.
...
\end{Sinput}
\begin{Soutput}
Median power WITHOUT missingness: 0.72 
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
Median power WITH missingness:    0.72 
\end{Soutput}
\end{Schunk}

Including missingness in simulations typically reduces power estimates, but in this dataset the effect is minimal. This may be due to the low power already available in this experiment. \package{peppwR} provides useful tools for assesing the extent and effect of missingness in phosphoproteomics analysis.
...
\begin{leftbar}
Thanks to Frank Menke and The Sainsbury Laboratory proteomics team for interesting discussions and comments.
\end{leftbar}
