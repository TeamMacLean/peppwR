...
```
    ...
    ## Rows: 26,820
    ## Columns: 7
    ## $ protein_name      <chr> "AT3G05900", "AT3G05900", "AT3G05900", "AT3G05900", …
    ## $ genotype          <chr> "Col-0", "Col-0", "Col-0", "Col-0", "Col-0", "Col-0"…
    ...
    ## $ new_annotation    <chr> "YVVDEPSKDETT[+80]SESGSALCPEK", "YVVDEPSKDETT[+80]SE…
